...
<input className="w-full border p-2 mb-3" placeholder="Short Description" />
<textarea className="w-full border p-2 mb-3" placeholder="Full Description" />
<input className="w-full border p-2 mb-3" placeholder="Price" />
<input className="w-full border p-2 mb-3" placeholder="Image URL" />


<button className="w-full py-2 bg-blue-600 text-white rounded">Submit</button>
</div>
</Protected>
)
}